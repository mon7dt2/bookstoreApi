...
//    Page<Category> getAllCategories(Pageable pageable);
    ...
    @Query("SELECT new mon7.project.bookstore.category.model.view.CategoryPreview(c.id, c.displayName, c.coverUrl) " +
            " FROM Category c WHERE c.isDeleted = 0")
    Page<CategoryPreview> getAllCategories(Pageable pageable);
